...
public class SessionSimulator {
	...
	private void displayInvoice(InvoiceInformation invoice) {
		System.out.println("");
		System.out.println("Name: " + invoice.forename + " " + invoice.surname);
		System.out.println("Base price: " + invoice.basePrice / 100. + " Euro");
		System.out.println("Total data volume: " + invoice.dataVolume + " MB");
		System.out.println("Total voice minutes: " + invoice.voiceMinutes + " minutes");

		if (invoice.dataVolumeUpgrades > 0)
			System.out.println("Data volume upgrades purchased: " + invoice.dataVolumeUpgrades);
		System.out.println("Total charge: " + invoice.totalCharge / 100. + " Euro");
	}
	...
	private void addUser() {
		...
		String subscriptionType = selectTypeFromList(config.getPossibleSubscriptionTypes(),
				"Select new subscription (enter the number on the left):", null);
		String terminalType = selectTypeFromList(config.getPossibleTerminalTypes(),
				"Select new terminal (enter the number on the left):", null);
	...
	private void newSession() {
		...
		String serviceType = selectTypeFromList(config.getPossibleServices(),
				"Select service (enter the number on the left):", null);
		System.out.println();
